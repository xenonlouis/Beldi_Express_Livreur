...
class CommandpendingPage extends StatefulWidget {
  final FirestoreService firestoreService;

  const CommandpendingPage({super.key, required this.firestoreService});

  @override
  State<CommandpendingPage> createState() => _CommandListPageState();
}

class _CommandListPageState extends State<CommandpendingPage> {

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body: FutureBuilder<List<Command>>(
        future: widget.firestoreService.getCommandspen(),
                  ...
                  child: ListTile(
                    ...
                    trailing: Container(
                      ...
                      decoration: BoxDecoration(
                        color: command.status == 'preparing'
                            ? Colors.yellow
                            : Colors.blue,
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () async {
                firestoreService.updatestatus(command.id, command.status);
